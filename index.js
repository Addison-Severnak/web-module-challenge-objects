...
console.log(createMenuItem('Toast', 1, 'Breakfast'));
...
console.log(addReview(reviews, 'Addison', 5, 'Wow, so good!'));
...
function getReviewByIndex(review, number) {
  return `${review[number].name} gave the restaurant a ${review[number].rating} star review, and their feedback was: ${review[number].feedback}`;
}
